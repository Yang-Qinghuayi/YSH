<template>
  <v-hover v-slot="{ isHovering, props: hoverProps }">
    ...
    >
      ...
      <div
        class="d-flex align-start justify-space-between flex-fill px-4 flex-column text-onSurfaceVariant"
      >
...
const canPlay = computed(() => {
  return ["daily", "album", "playlist", "artist", "recent", "program"].includes(
    props.type
  );
});
async function play() {
