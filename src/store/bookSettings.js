...
export const useBookSettingsStore = defineStore('bookSettings', {
  ...
  actions: {
    ...
    SET_DEFAULTFONTSIZE(options) {
      /* 设置默认字体大小 */ this.defaultFontSize = options
    },
    SET_DEFAULTFONTFAMILY(options) {
      this.defaultFontFamily = options
    },
    ...
    SET_SHELF_SELECTED(options) {
      this.shelfSelected = options
    },
  },
})
