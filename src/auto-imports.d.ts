...
declare global {
  ...
  const effectScope: typeof import('vue').effectScope
  const envConfig: typeof import('./hooks/useEnv').envConfig
  ...
  const libraryLoaded: typeof import('./hooks/useEnv').libraryLoaded
  ...
  const useClickEvent: typeof import('./hooks/useIframeEvents').useClickEvent
  ...
  const useDialogEsc: typeof import('./hooks/useDialogEsc').useDialogEsc
  ...
  const useNavItems: typeof import('./hooks/useNavItems').useNavItems
  ...
  const usePageFlip: typeof import('./hooks/usePageFlip').usePageFlip
  ...
  const useProgressAutoSave: typeof import('./hooks/useProgressAutoSave').useProgressAutoSave
